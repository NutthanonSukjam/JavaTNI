...
public class TicketUsed {
    ...
    public static String show_movie_list(Ticket... tickets) {
        ...
        for (Ticket t : tickets) {
            list += t.getTicketId() + ": " + t.getMovie().toString() + "\n";
        }
        return list;
    }
        ...
        while (true) {
            ...
            if (inputId != null) {
                ...
                for (Ticket ticket : tickets) {
                    if (ticket.getTicketId().equalsIgnoreCase(inputId)) {
                        found = true;


                        String menuMsg = ticket.getTicketId() + ": " + ticket.getMovie().toString() + "\n\n" +
                        ...
                        if (menu != null) {
                            switch (menu) {
                                ...
                                case "2": {
                                    String result = ticket.useTicket() + "\n\n" + ticket.toString();
                                    JOptionPane.showMessageDialog(null, result);
                                    break;
                                }
                            }
